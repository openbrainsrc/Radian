<h3>Example 78 (more legends)</h3>

<plot height=300 aspect=3>
  <legend></legend>
  <lines label="Temperature" stroke-width=2 stroke="red"
         x="[[vic2012ooa.date]]" y="[[vic2012ooa.tmp]]"/>
  <bars label="Rainfall" stroke-width=2 fill="lightblue"
        fill-opacity=0.5 stroke="blue"
        x="[[midMonths(unique(vic2012ooa.date#getMonth()), 2012)]]"
        y2="[[meanBy(vic2012ooa.prc,vic2012ooa.date#getMonth())]]"/>
</plot>
...
<plot height=600 aspect=1
  ...
  <legend>
    <legend-entry label="Female" type="points" marker="circle" fill="#FF7F7F">
    </legend-entry>
    <legend-entry label="Male" type="points" marker="circle" fill="#7F7FFF">
    </legend-entry>
  </legend>
  <points x="[[fam.age]]" y="[[fam.height]]" fill="[[mfpal(fam.sex)]]"></points>
</plot>
...
<plot-data name="fam" format="csv" cols="name,age,height,sex,salaryhr">
Tom,35.1,6.3,male,20
Harriet,1.5,2.1,female,10
Antonia,35.2,5.1,female,25
Ada,4.5,3.1,female,12
Foo,10.1,3.9,female,15
Bar,80.4,9.1,female,22
Baz,5.2,3.2,male,13
Jim,60.1,8.1,male,24
Ted,70.1,9.1,male,18
Jerry,40.6,7,male,16
</plot-data>
